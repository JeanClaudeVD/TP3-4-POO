...
import fr.ensim.TP3.Tp3Application;
import fr.ensim.TP3.model.Weather;
...
public class MeteoController {
    ...
    public String post(@RequestParam("address") String address, Model model) throws IOException, JSONException {
        ...
        // Looking for the coordinates of the given address
...
//        Asking for the meteo forecast at the given coordinates using MeteoConcept API
